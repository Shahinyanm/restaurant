...
@section('main')
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
    ...
    <script src="<?= base_url('assets/js/plugins/jquery.vmap.min.js') ?>"></script>
    <script src="<?= base_url('assets/js/plugins/jquery.vmap.world.js') ?>"></script>
    <script src="<?= base_url('assets/js/plugins/jquery.vmap.sampledata.js') ?>"></script>
